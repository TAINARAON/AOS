...
function setOnCreateBrokerListener() {
	...
	$('#insurer_admin_create_broker_button').on('click',function() {
		loader.loadPage('html/insurer/broker/createBroker.html');
	});
}
...
function setOnCreateBrokerageListener() {
	...
	$('#insurer_admin_create_brokerage_button').on('click',function() {
		loader.loadPage('html/insurer/broker/createBrokerage.html');
	});
}

function getBrokeragesAndTheirBrokers() {

	insurerController.getBrokeragesAndTheirBrokers(onGetBrokeragesAndTheirBrokersSuccess,onGetBrokeragesAndTheirBrokersFailure);
}
...
function onEditBroker(id) {
	...
	insurerController.getBrokerForEditModal(getBrokerForEditModalSuccessCallback,getBrokerForEditModalFailureCallback,id);
}
...
function getBrokerForEditModalFailureCallback(result) {
	...
	alert("getBrokerForEditModalFailureCallback broker/brokerage/brokerage.js");
...
function editBroker(brokerId) {
	...
	brokerController.editBroker(editBrokerSuccessCallback,editBrokerFailureCallback,requestObject);
}
