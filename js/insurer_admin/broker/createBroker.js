...
function onGetBrokeragesSuccess(response) {
	...
	var brokerages = response;

	populateBrokerageDropdown(brokerages);
}
function onGetBrokeragesFailure(response) {

	alert("failed to get Brokerages - insurerAdminController createBroker");
}
...
function getBrokersOfBrokerage() {
	...
	insurerAdminController.getBrokersOfBrokerage(onGetBrokersOfBrokerageSuccess,onGetBrokersOfBrokerageFailure,brokerageId,);
}
...
function onCreateBrokerDocumentsSubmittedCallback(fileData,data) {
	...
	insurerAdminController.createBroker(onBrokerCreatedSuccess,onBrokerCreatedFailure,requestObject);
}
