var quoteViewer = new function () 
{
	...
	{
		loader.loadPartOfPage("html/client/quote/create.html", id);
	}

	function createAcceptQuoteModal(id)
	{
		loader.loadPartOfPage("html/client/quote/accept.html", id);
	}

	function createShareQuoteModal(id)
	{
		loader.loadPartOfPage("html/client/quote/share.html", id);
	}
